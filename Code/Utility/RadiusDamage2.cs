...
public sealed class RadiusDamage2 : Component
{
	...
	public void Apply()
	{
		...
		ApplyDamage( sphere, dmg, occlusion: Occlusion );
		ApplyForces( sphere, PhysicsForceScale, Occlusion );
	}

	void ApplyDamage( Sphere sphere, DamageInfo damage, GameObject ignore = null, bool occlusion = true )
	{
	...
	void ApplyForces( Sphere sphere, float physicsForce, bool occlusion, GameObject ignore = null )
	{
		var point = sphere.Center;
		var objectsInArea = Scene.FindInPhysics( sphere );
