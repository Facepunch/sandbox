...
public partial class GravGun : Carriable
{
	...
	public override void Simulate( Client client )
	{
		...
		using ( Prediction.Off() )
		{
			...
			if ( HeldBody.IsValid() && HeldBody.PhysicsGroup is not null )
			{
			...
			if ( tr.Entity.PhysicsGroup is null )
				return;
	...
	{
		return Owner is null || HeldBody.IsValid();
	}
}
